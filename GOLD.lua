...
SUDO = SUDO
sudo_users = {SUDO,1614314857,1751768178,1903411846,1304868679,1965534755}   
print([[
> CH › @AKJA0
> CH › @T_aLeN
~> DEVELOPER › @JAI6H
...
if text == 'جابوا' or text == 'الصعيدي' or text == 'مصطفي' or text == '⌯ جـــاــافـــــا ⌯' or text == 'روح العتتالمي' then
local Text =[[
↝𝐉𝐚𝐛𝐰𝐚 ✹🇦🇺
]]
keyboard = {} 
...
{
{text = '↝ 𝗝𝗮𝗯𝘄𝗮 ✹🇦🇺', url = "https://t.me/J_A_B_W_A"},
},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '𝐉𝐚𝐛𝐰𝐚', url="t.me/J_A_B_W_A"},{text = '𝐃𝐞𝐯 𝐀𝐛𝐝𝐨', url="t.me/DV_ABDO"}},
{{text = 'رجوع ➥', callback_data="/help14"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
